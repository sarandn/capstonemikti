...
func (r *CategoryRepository) Create(category *model.Category) error {
	...
	err := r.db.QueryRow(query, category.CategoryName).Scan(&category.CategoryIDFK)
	if err != nil {
...
func (r *CategoryRepository) GetByID(categoryID int) (*model.Category, error) {
	...
	err := row.Scan(&category.CategoryIDFK, &category.CategoryName)
	if err != nil {
...
func (r *CategoryRepository) GetAll() ([]*model.Category, error) {
	...
	for rows.Next() {
		var category model.Category
		if err := rows.Scan(&category.CategoryIDFK, &category.CategoryName); err != nil {
...
func (r *CategoryRepository) Update(category *model.Category) error {
	...
	_, err := r.db.Exec(query, category.CategoryName, category.CategoryIDFK)
	if err != nil {
